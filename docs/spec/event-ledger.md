...
- [ ] Tool function 5 個 method 全部 emit `succeeded` / `failed`，覆蓋 13 個 P0 events
...
- [ ] 13 個 P0 event_type 各至少一筆 fixture，能用 §7 的 query examples 跑通
